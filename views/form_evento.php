          ...
          <div class="flex items-center space-x-4">
            <div
              ...
              <img alt="Pré-visualização da Foto 1 do evento, espaço reservado para imagem carregada pelo usuário"
                height="80" width="80" id="preview-foto1" src="<?= $edicao ? htmlspecialchars(Constants::BASE_URL . 'uploads/' . $evento['publicacaofoto01']) : 'https://placehold.co/80x80' ?>"
          ...
          <div class="flex items-center space-x-4">
            <div
              ...
              <img alt="Pré-visualização da Foto 2 do evento, espaço reservado para imagem carregada pelo usuário"
                height="80" width="80" id="preview-foto2" src="<?= $edicao ? htmlspecialchars(Constants::BASE_URL . 'uploads/' . $evento['publicacaofoto02']) : 'https://placehold.co/80x80' ?>"
                class="max-h-full max-w-full object-contain" />
            </div>
